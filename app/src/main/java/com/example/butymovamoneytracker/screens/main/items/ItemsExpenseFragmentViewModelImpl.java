...
public class ItemsExpenseFragmentViewModelImpl extends ItemsFragmentViewModelImpl {

    @Inject
    ItemsExpenseFragmentViewModelImpl(Api api,
                                      Database database,
                                      ItemEntityMapper mapper,
                                      Prefs prefs,
                                      @Expense TypePage typePage,
                                      SelectedItems selectedItems,
                                      ActionModeState actionModeState,
                                      FilterState filterState,
                                      SearchState searchState,
                                      @Expense ItemsCountState itemsCountState,
